...
export default function PaginationComponent(props:IPaginationProps):JSX.Element {
  ...
  const onClickPrevPage = (event:MouseEvent<HTMLDivElement>):void => {
    if (startPage === 1) return;
    setStartPage(startPage - 10);
    setActivePage(startPage - 10);
    void props.refetch({page: startPage - 10})
  }
  const onClickNextPage = (event: MouseEvent<HTMLDivElement>):void => {
